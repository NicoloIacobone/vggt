...
| VGGT-Segmentor | [2604.13596](https://arxiv.org/abs/2604.13596) | **YES — MISCLASSIFIED by the harvest** | Actually Ego-Exo4D ego↔exo mask *transfer* (mask-prompt fusion + point-guided prediction, self-supervised), **not** ScanNet 3D instance segmentation. Cite as related, not as a scoop. |
