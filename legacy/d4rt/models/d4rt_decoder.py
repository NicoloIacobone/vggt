...
from legacy.d4rt.models.mask_upsampler import MaskUpsampler
...
class QueryGenerator(nn.Module):
    ...
    def __init__(
        ...
        # pointmap (legacy/d4rt/models/anchor_queries.py builds the anchors at bundle-caching time).
...
class D4RTInstanceSegmentationHead(nn.Module):
    ...
    def __init__(
        ...
        # module itself — anchors are built outside (legacy/d4rt/models/anchor_queries.py) from the
