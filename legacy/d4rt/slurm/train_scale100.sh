...
# Submit: sbatch --export=ALL,INSTANCE_LEVEL=1 legacy/d4rt/slurm/train_scale100.sh
#
#SBATCH --job-name=d4rt_scale100
#SBATCH --output=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale100_%j.log
#SBATCH --error=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale100_%j.err
