...
#SBATCH --output=/cluster/scratch/niacobone/vggt/slurm/logs/eval_grid_ablation_%j.log
#SBATCH --error=/cluster/scratch/niacobone/vggt/slurm/logs/eval_grid_ablation_%j.err
...
for CKPT in checkpoint_best_ap50.pth checkpoint_best.pth; do
    $PYTHON legacy/d4rt/scripts/eval_grid_ablation.py \
