...
# Submit from anywhere: sbatch legacy/d4rt/slurm/train_scale25.sh
#
#SBATCH --job-name=d4rt_scale25
#SBATCH --output=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale25_%j.log
#SBATCH --error=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale25_%j.err
...
$PYTHON legacy/d4rt/scripts/train_multiscene.py \
    ...
    --cache_device cpu \
    --save_checkpoint $OUT/d4rt_m2_scale25${RUN_TAG}_$(date +%Y%m%d_%H%M%S)/checkpoint.pth
