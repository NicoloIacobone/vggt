...
# Submit from anywhere: sbatch legacy/d4rt/slurm/train_scale50.sh
#
#SBATCH --job-name=d4rt_scale50
#SBATCH --output=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale50_%j.log
#SBATCH --error=/cluster/scratch/niacobone/vggt/slurm/logs/train_scale50_%j.err
