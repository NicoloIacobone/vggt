#!/usr/bin/env python3
"""
Phase 5 validation: the MaskDINO-style pixel decoder (legacy/d4rt/models/mask_upsampler.py) and its
...
from legacy.d4rt.models.d4rt_decoder import InstanceDecoder
