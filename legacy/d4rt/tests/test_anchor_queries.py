#!/usr/bin/env python3
"""
Arm E validation: 3D-anchored queries (legacy/d4rt/models/anchor_queries.py + query_mode="anchor3d").
...
from legacy.d4rt.models.anchor_queries import (
    patch_token_positions, farthest_point_sample, build_anchors, jitter_anchors)
from legacy.d4rt.models.d4rt_decoder import (
