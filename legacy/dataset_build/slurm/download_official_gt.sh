#!/bin/bash
# Phase 2 of docs/old/OFFICIAL_GT_MIGRATION_PLAN.md: download the official ScanNet
...
#
# Dual-use: `sbatch legacy/dataset_build/slurm/download_official_gt.sh [start] [end]` or
# `bash legacy/dataset_build/slurm/download_official_gt.sh [start] [end]` on a login node.
#
#SBATCH --job-name=official_gt_dl
#SBATCH --output=/cluster/scratch/niacobone/vggt/slurm/logs/official_gt_dl_%j.log
#SBATCH --error=/cluster/scratch/niacobone/vggt/slurm/logs/official_gt_dl_%j.err
