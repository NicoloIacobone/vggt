"""Test legacy/dataset_build/scripts/extract_sens_subset.py — synthetic .sens stream -> stride-5 subset jpgs.
...
CPU-only, no network. Run: python legacy/dataset_build/tests/test_extract_sens_subset.py
"""
import io
import struct
import sys
...
from legacy.dataset_build.scripts.extract_sens_subset import (  # noqa: E402
