...
the official-GT migration (docs/OFFICIAL_GT_MIGRATION_PLAN.md, Phase 2). Differences:
...
- Optional --convert_out: after both zips of a scene arrive, runs
  scripts/build_official_masks.py::convert_scene on them and DELETES the zips on
...
def main() -> None:
    ...
    if args.convert_out:
        ...
        from scripts.build_official_masks import convert_scene
