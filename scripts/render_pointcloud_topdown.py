...
Example:
    python scripts/render_pointcloud_topdown.py \
...
matplotlib and CPU-testable without the backbone: tests/test_render_topdown.py.
"""
...
from train.postprocess import select_instances, upsample_assignment  # noqa: E402
from data.scannet_overfit import (  # noqa: E402
    IDX_TO_CLASS, decode_checkpoint_images, load_frames_by_name,
)
from models.anchor_queries import build_anchors  # noqa: E402
