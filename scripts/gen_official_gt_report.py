...
Phase-2 QA + deliverable report for docs/OFFICIAL_GT_MIGRATION_PLAN.md, in the style
...
Converter: `scripts/build_official_masks.py` in the vggt repo
(tests: `tests/test_build_official_masks.py`).
