"""Test scripts/build_official_masks.py — synthetic official-GT pairs -> SAM3 layout.
...
CPU-only, no downloads, no torch. Run: python tests/test_build_official_masks.py
"""
import json
import sys
import tempfile
...
from scripts.build_official_masks import convert_scene, load_label_map  # noqa: E402
